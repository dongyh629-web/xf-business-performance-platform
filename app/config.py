...
CUSTOMER_ACTIONABLE_MAX_DAYS_SINCE_ORDER = 90
CUSTOMER_ACTIONABLE_MIN_HISTORICAL_SALES = 3000
CUSTOMER_ACTIONABLE_MIN_INTERVAL_RATIO = 1.4
CUSTOMER_ACTIONABLE_MAX_INTERVAL_RATIO = 5.0
